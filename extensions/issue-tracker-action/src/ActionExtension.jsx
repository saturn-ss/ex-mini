...
// The target used here must the target used in the extension's .toml file at ./shopify.extension.toml
const TARGET = 'admin.product-details.action.render';

export default reactExtension(TARGET, () => <App />);

function App() {
  // connect with the extenstion's APIs
    ...
    >
      ...
      <Box paddingBlockStart="large">
        <TextArea
          ...
          onChange={(val) => setIssue((prev) => ({...prev, description: val}))}
          label="Description"
          maxLength={300}
        />
      </Box>
