...
function App() {
  ...
  const paginatedIssues = useMemo(() => {
    if (issuesCount <= PAGE_SIZE) {
      // It's not necessary to paginate if there are fewerissues than the page size
      return issues;
    }

    // Slice the array after the last item of the provious page
    return [...issues].slice(
        ...
        {issues.length ? (
                      ...
                      >
                        ...
                        <Box inlineSize="22%">
                          <Select
                            ...
                            name="status"
                            defaultValue={
                              initialValues[index] ? "comleted" : "todo"
                            }
          ...
          <>
            <Box paddingBlockEnd="large">
              <Text fontWeight="blod">No issues for this product</Text>
            </Box>
          </>
        )}
      </Form>
